			...
			<div class="header">
				<div class="rightTopHeader">
					...
					<div class="cartContainer">
						<div class="myCart">
							<ul>
								<li class="cartTitle"><a href="{{URL::route('viewcart')}}"><img src="{{asset('img/shop/cart.png')}}" alt=""></a><span>{{\App\Cart::JumlahItem()}}</span></li>
							</ul>
						</div><!-- end myCart -->
						<div class="cartParent">
							<div class="cartItems">
								<ul>
									...
									<li>
										<div class="priceCart">
											<img src="{{asset('/img/shop/'.\App\Shop::GambarProduk($item->id_product))}}" alt="" class="object-fit_contain">
						...
						<nav>
							...
							<ul>
								...
								<nav class="social-iconssss" style="text-align: center; margin: auto; display: block;">
									<ul>
										<a href="https://itunes.apple.com/id/album/proper-pause-ep/id1151893533" class="icon-button shopIcon"><i class="fa fa-facebook" style="font-size: 17px; width: 50px; background-color: transparent; text-align: center; color: #000;"></i><span></span></a>
										<a href="https://itunes.apple.com/id/album/proper-pause-ep/id1151893533" class="icon-button shopIcon"><i class="fa fa-twitter" style="font-size: 17px; width: 50px; background-color: transparent; text-align: center; color: #000;"></i><span></span></a>
									</ul>
								</nav>
							<!-- Menu Fixed Close Button -->
							<div class="x-filter">
			...
			<div class="container">
				<div class="subscribefooter">
					...
					{{ csrf_field() }}
						...
						<p class="form-submit">
							<input name="submit" type="submit" id="submit" value="SIGN UP" data-toggle="modal" data-target="#add_data_Modal">
						</p>
					</form>
				</div>
				<div class="row">

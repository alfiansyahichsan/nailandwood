<!--halaman setting pada admin panel-->
...
<script>
		...
		jQuery(function($) {
			...
			var i = 1;
			$("#add").click(function(){//fungsi untuk menduplikasi row pada tabel
						...
						<tbody>
							...
							<tr class="tr_clone">
								...
								<input type="hidden" name="#" class="deletep" value="0">
									...
									<td><input type="text" value="row diclone (isinya bebas)" name="%" class="form-control" disabled></td>

      ...
      <table class="table table-borderless" id="table">
        ...
        @foreach($news as $ne)
            <tr class="item{{$ne->id}}">
                ...
                <button class="edit-modal btn btn-primary" data-id="{{$ne->id}}" data-imgpath="{{$ne->imgpath}}" data-linkvideo="{{$ne->linkvideo}}" data-title="{{$ne->title}}" data-text="{{$ne->text}}" data-category="{{$ne->category}}">
                <span class="glyphicon glyphicon-edit"></span> Edit
                </button>
                <button class="delete-modal btn btn-danger" data-id="{{$ne->id}}" data-imgpath="{{$ne->imgpath}}" data-linkvideo="{{$ne->linkvideo}}" data-title="{{$ne->title}}" data-text="{{$ne->text}}" data-category="{{$ne->category}}">
